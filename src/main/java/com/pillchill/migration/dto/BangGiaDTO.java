...
public class BangGiaDTO implements Serializable {
    ...
    public BangGiaDTO(String maBangGia, String tenBangGia, String loaiGia, LocalDate ngayApDung, LocalDate ngayKetThuc, String trangThai, String ghiChu, int doUuTien, boolean isActive) {
